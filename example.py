...
st.write("---")
st.title("Section 0: How this file works")
st.code("""
 # code to run cool streamlit stuff will be here.
""")
st.write("---")

st.write("Whatever is between these two lines will be the result of the code that is from the code block above it. This is how you can run code and display the results in streamlit.")
